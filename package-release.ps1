...
try {
    ...
    Copy-Item -LiteralPath (Join-Path $releaseDirectory "archive-rclick-cli.exe") -Destination $output
    Copy-Item -LiteralPath (Join-Path $repository "CLI.md") -Destination $output
